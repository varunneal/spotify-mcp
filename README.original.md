# Original README (upstream `varunneal/spotify-mcp`)

> This file is a snapshot of the upstream project's README at the time this fork
> (`Danieloni1/spotify-mcp`) diverged. The active, fork-maintained README lives
> in [`README.md`](./README.md). Kept here for attribution and historical context.
